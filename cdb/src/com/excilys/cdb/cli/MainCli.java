...
public class MainCli {
	...
	private static ComputerDao computerDao = ComputerDaoImpl.INSTENSE.getInstance();
	private static CompanyDao companyDao = CompanyDaoImpl.INSTENSE.getInstance();
	...
	private void add(){
		...
		System.out.println(computerDao.create(new Computer(name, introduced, discontinued, companyId)));
	}
	...
	private void update(int index){
		...
		System.out.println(computerDao.update(new Computer(index, name, introduced, discontinued, companyId)));
	}
