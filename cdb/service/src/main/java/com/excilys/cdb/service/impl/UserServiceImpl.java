...
public class UserServiceImpl implements UserService {
	...
	public UserDetails loadUserByUsername(final String username) throws UsernameNotFoundException {
		...
		final List<GrantedAuthority> authorities = buildUserAuthority(userJPA.getRole());
	...
	private User buildUserForAuthentication(com.excilys.cdb.persistence.dto.UserJPA userJPA,
		...
		return new User(userJPA.getUsername(), userJPA.getPassword(), true, true, true, true, authorities);
	}
