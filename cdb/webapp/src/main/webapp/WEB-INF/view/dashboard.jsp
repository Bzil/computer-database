            ...
            <security:authorize access="hasRole('ROLE_ADMIN')">
                <div class="pull-right">
                    ...
                    <a class="btn btn-default" id="editComputer" href="#"
                       onclick="$.fn.toggleEditMode();"><spring:message code="edit.computer"/></a>
                </div>
            </security:authorize>
        </div>
    </div>
        ...
        <table class="table table-striped table-bordered">
                ...
                <security:authorize access="hasRole('ROLE_ADMIN')">
                    <th class="editMode" style="width: 60px; height: 22px;"><input type="checkbox" id="selectall"/>
                        <span style="vertical-align: top;"> - <a href="#" id="deleteSelected"
                                ...
                                class="fa fa-trash-o fa-lg"></i></a> </span>
                    </th>
                </security:authorize>
            ...
            <c:forEach items="${page.entities}" var="computer">
                <tr>
                    ...
                    <td>
                        <security:authorize access="hasRole('ROLE_ADMIN')"><a href="edit?id=${computer.id}"
                                                                              onclick=""></security:authorize>
                            ${computer.name}
