               ...
               <form:form commandName="computerDto" action="edit" method="POST">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <form:input path="name" type="text" cssClass="form-control" id="name" name="name"
                                        placeholder="${computerName}" value="${computer.name}"/>
                        ...
                        <div class="form-group">
                            ...
                            <form:label path="introduced" for="introduced"><spring:message
                                    code="introduced.date"/></form:label>
                            <form:input path="introduced" type="date" cssClass="form-control" id="introduced"
                                        name="introduced"
                        ...
                        <div class="form-group">
                            <form:label path="discontinued" for="discontinued"><spring:message
                                    code="discontinued.date"/></form:label>
                            <form:input path="discontinued" type="date" cssClass="form-control" id="discontinued"
                                        name="discontinued"
                    ...
                    <div class="actions pull-right">
                        <input type="submit" value="<spring:message code="button.edit" />" class="btn btn-primary"
                               id="buttonControl" disabled="disabled">
                        <spring:message code="or"/>
                        <a class="btn btn-default" href="<c:url value="/dashboard" />"><spring:message
