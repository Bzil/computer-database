		...
		<div class="container">
			...
			<form name='connect' action='login' method='POST'>
				...
				<div class="form-signin input-group">
					...
					<input class="form-control up"   name='username' placeholder="<spring:message code="username"/>" type="text" />
				</div>
				
				<div class="form-signin input-group">
				<!-- Password input-->
					<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
					<input class="form-control down" name='password' placeholder="<spring:message code="password"/>" type="password" />
				</div>
