...
public class SortCriteria {
	...
	/**
	 * Builds the sort criteria.
	 *
	 * @param column the column
	 * @param dir the dir
	 * @return the sort criteria
	 */
	public static SortCriteria buildSortCriteria(final String column, final String dir) {
		SortCriteria sort = null;
		if (column != null && dir != null && !column.trim().isEmpty() && !dir.trim().isEmpty()) {
			try {
				sort = new SortCriteria(SortColumn.valueOf(column.trim().toUpperCase()), SortDirection.valueOf(dir
						.trim()));
